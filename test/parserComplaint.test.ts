...
describe("Complaint parser", () => {
    test("Parse complaint successfully", async () => {
        ...
        const result = await parser.convertImageToBase64(mockUnparsedComplaints.complaints);
